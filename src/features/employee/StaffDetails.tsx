...
export default function CandidateDetails({ open, handleClose, handleChange }: any) {
  ...
  // const [department, setDepartment] = useState(userInfor?.departmentName);
  ...
  // const [bankAccount, seetBankAccount] = useState(userInfor?.bankAccount);
  // const [bankAccountName, setBankAccountName] = useState(userInfor?.bankAccountName);
  // const [bank, setBank] = useState(userInfor?.bank);
  // const [accountStatus, setAccountStatus] = useState(userInfor?.departmentName);
  ...
  //   }
  // }, [id, updatedSkills.length, dispatch, setUpdatedSkills]);
  ...
  //     setDepartment(userInfor.departmentName);
  ...
  //   console.log(candidateSkillId);
  //   setUpdatedSkills(
  //     candidateSkillsByCandidateId
  //       .filter((skill) => skill.uniqueId !== candidateSkillId)
  //       .map((skill) => ({
  //         id: skill.uniqueId,
  //         skill: skill.skillName,
  //         level: skill.level,
