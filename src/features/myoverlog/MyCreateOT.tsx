  ...
  function MyCreateOT({ open, handleClose, handleChange }: any) {
    ...
    const handleApi = () => {
      if (logStart && logEnd) {
        ...
        formData.append(
          "logStart",
          format(logStart, "yyyy-MM-dd'T'HH:mm:ss.SSSxxx")
        );
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <Grid item xs={12} sx={{ py: "8px", border: "4px" }}>
            <Grid container spacing={2}>
              <Grid item xs={3}>
                <Typography sx={headerStyle}>Loại tăng ca</Typography>
              </Grid>
              <Grid item xs={9}>
                <Grid item xs={9}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onChange={(e: any) => setOtTypeId(e?.target?.value)}
                    >
                      <MenuItem value={1}>Làm thêm ngày trong tuần</MenuItem>
                      <MenuItem value={2}>Làm thêm ngày cuối tuần</MenuItem>
                      <MenuItem value={3}>Làm thêm ngày lễ</MenuItem>
                    </Select>
                  </FormControl>
                </Grid>
              </Grid>
        ...
        <DialogActions>
          <Container sx={{ display: "flex", justifyContent: "center" }}>
            <Button onClick={handleClose} variant="outlined" sx={{ mr: "5px" }}>
              Hủy
            </Button>
            <Button onClick={handleApi} variant="contained" sx={{ ml: "5px" }}>
              Xác nhận
            </Button>
          </Container>
        </DialogActions>
