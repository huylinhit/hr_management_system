...
import ConfirmPayslips from "../payslip/component/ConfirmPayslips";
import { BootstrapInput } from "../payslip/component/CreatePayslipMainForm";
import CreatePayslipNewVersion from "../payslip/component/CreatePayslipNewVersion";
import {
  payslipSelectors,
  setPayslipParams,
  resetPayslipParams,
  fetchPayslipsAsync,
  fetchFiltersPayslips,
  setPageNumber,
} from "../payslip/payslipSlice";
...
export default function PayslipsMiniTable() {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderHeader: () => (
        <Typography display={"flex"} alignItems={"center"} sx={headerStyle}>
          <CalendarMonthIcon style={{ marginRight: 5 }} fontSize="small" /> <>Thời gian</>
        </Typography>
      ),
      renderCell: (params) => (
