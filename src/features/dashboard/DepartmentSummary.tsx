...
export default function DepartmentSummary() {
  const { departmentsLoaded, departmentsChanged } = useAppSelector((state) => state.department);
      ...
      <Card sx={cardStyle}>
        <Grid container xs={12}>
          <Grid container display={"flex"} justifyContent={"space-between"}>
            ...
            <Grid item>
              <Box sx={{ padding: "1px 7px", backgroundColor: "#FEDDC7", borderRadius: "8px" }}>
                <PeopleAltOutlinedIcon fontSize="small" sx={{ mt: "4px", color: "#FB9416" }} />
              </Box>
            </Grid>
          </Grid>
