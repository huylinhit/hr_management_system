    ...
    <>
      {payslip && (
        <Box>
          ...
          <Grid container sx={{ px: "32px", py: "12px" }}>
            {/* Left Container */}
            <Grid item xs={6} pr="12px">
              ...
              <PayslipDetailSalary
                ...
                taxableIncome={
                  payslip?.salaryBeforeTax - payslip?.selfDeduction - payslip?.familyDeduction
                }
            ...
            <Grid item xs={6} pl="12px">
              <DetailAllowance allowances={allowances} totalAllowance={totalAllowances} />
              ...
              <TaxDetailList taxDetails={payslip?.taxDetails!} />
              <LogOvertimeTable
                logOts={logotsStaff}
