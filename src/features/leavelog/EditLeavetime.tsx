...
function EditLeavetime({ open, handleClose, handleChange }: any) {
    ...
    return ( 
        ...
        <Container >
          ...
          <Grid container >
            <Grid item xs={24} sx={{ py: '8px', border: '4px' }}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={9}><Typography >Nghỉ thai sản</Typography></Grid>
              </Grid>
            </Grid>
          </Grid>
          ...
          <Grid container >
            <Grid item xs={24} sx={{ py: '8px', border: '4px' }}>
              <Grid container spacing={2}>
                <Grid item xs={3}><Typography sx={headerStyle}>Số ngày nghỉ</Typography></Grid>
                <Grid item xs={9}><Typography >3 ngày</Typography></Grid>
              </Grid>
            </Grid>
          </Grid>
          <Grid container >
